...
export const translations = {
  en: {
    ...
    agentCashOutTitle: 'Agent Cash Out',
    agentMobile: "Agent's Mobile",
  ...
  bn: {
    ...
    haveAccount: 'ইতিমধ্যে একটি অ্যাকাউন্ট আছে? লগইন করুন',
    noAccount: 'অ্যাকাউন্ট নেই? সাইন আপ করুন',
    pinMismatch: 'পিন মেলেনি!',
    pinInvalid: 'পিন অবশ্যই ৪ সংখ্যার হতে হবে।',
    loginWithBiometrics: 'বায়োমেট্রিক দিয়ে লগইন করুন',
    enableBiometrics: 'বায়োমেট্রিক লগইন চালু করুন',
    biometricsEnabled: 'বায়োমেট্রিক চালু হয়েছে!',
    ...
    processCashOut: 'ক্যাশ আউট প্রসেস',
    receivedMoney: 'টাকা গ্রহণ',
    ...
    agentCashOutTitle: 'এজেন্ট ক্যাশ আউট',
    agentMobile: 'এজেন্টের মোবাইল',
    cashOutRequest: 'ক্যাশ আউট অনুরোধ',
